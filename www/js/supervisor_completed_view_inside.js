...
// /alert(oneemp);
  $('.s22').append('<li><a href="http://verify.fourthforce.in/uploads/'+oneemp+'"><img src="http://verify.fourthforce.in/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
var oneemp=employimg_obj.document;
//alert(oneemp);
  $('.sddqicom').append('<li><a href="http://verify.fourthforce.in/uploads/'+oneemp+'"><img src="http://verify.fourthforce.in/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(oneemp);
  $('.s22').append('<li><a href="http://verify.fourthforce.in/uploads/'+oneemp+'"><img src="http://verify.fourthforce.in/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
     ...
     $('.s2').append('<li><a href="http://verify.fourthforce.in/uploads/'+one+'"><img src="http://verify.fourthforce.in/uploads/'+one+'" style="height: 100%;width:100%" ></a></li>');
      ...
      if (k == 1 ){
        ...
        //alert(oneo+'two');
     $('.s2').append('<li><a href="http://verify.fourthforce.in/uploads/'+oneo+'"><img src="http://verify.fourthforce.in/uploads/'+oneo+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(oneemp);
  $('.s22').append('<li><a href="http://verify.fourthforce.in/documents/addressid/'+oneemp+'"><img src="http://verify.fourthforce.in/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
if (j == 0 ){
  ...
  $('.s2').append('<li><a href="http://verify.fourthforce.in/documents/addressid/'+one+'"><img src="http://verify.fourthforce.in/documents/addressid/'+one+'"  style="height: 100%;width:100%"></a></li>');
...
if (j == 1 ){
  ...
  //alert(oneo+'two');
  $('.s2').append('<li><a href="http://verify.fourthforce.in/documents/addressid/'+oneo+'"><img src="http://verify.fourthforce.in/documents/addressid/'+oneo+'"  style="height: 100%;width:100%"></a></li>');
