...
//alert(oneemp);
  $('.sddqi').append('<li><a href="http://verify.fourthforce.in/uploads/'+oneemp+'"><img src="http://verify.fourthforce.in/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
var oneemp=employimg_obj.document;
// /alert(oneemp);
  $('.sddq').append('<li><a href="http://verify.fourthforce.in/uploads/'+oneemp+'"><img src="http://verify.fourthforce.in/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
var oneemp=employimg_obj.document;
//alert(oneemp);
  $('.sddq').append('<li><a href="http://verify.fourthforce.in/uploads/'+oneemp+'"><img src="http://verify.fourthforce.in/uploads/'+oneemp+'" style="height: 100%;width:100%" onerror="imgError(this);"></a></li>');
...
//$('.document_imag_inprooneqc').append('<img src="http://staging.eimpressive.com/uploads/'+one+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
 $('.s').append('<li><a href="http://verify.fourthforce.in/uploads/'+one+'"><img src="http://verify.fourthforce.in/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inprooneqd').append('<img src="http://staging.eimpressive.com/uploads/'+oneo+'" alt="Band" title="My favourite band" class="rondell-item-image rondell-item-resizeable">');
 $('.s').append('<li><a href="http://verify.fourthforce.in/uploads/'+oneo+'"><img src="http://verify.fourthforce.in/uploads/'+oneo+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneemp);
  $('.sddq').append('<li><a href="http://verify.fourthforce.in/documents/addressid/'+oneemp+'"><img src="http://verify.fourthforce.in/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
$('.s').append('<li><a href="http://verify.fourthforce.in/documents/addressid/'+one+'"><img src="http://verify.fourthforce.in/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
$('.s').append('<li><a href="http://verify.fourthforce.in/documents/addressid/'+oneo+'"><img src="http://verify.fourthforce.in/documents/addressid/'+oneo+'"  style="height: 300px;width:350px"></a></li>');
...
$.ajax({url: "http://verify.fourthforce.in/slim_force/slim_four_ripsssjs/supervisor_status_to_verified.php?status_val_inpro="+status_val_inpro+"&verification_user_id="+verification_user_id+"&remark_inpro="+remark_inpro+"&coordinator_id="+coordinator_id+"&region_num="+region_num+"&activity_log="+activity_log+"&sdocument="+sdocument,
