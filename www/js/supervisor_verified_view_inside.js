...
//alert(oneemp);
  $('.sddqiveri').append('<li><a href="http://verify.fourthforce.in/uploads/'+oneemp+'"><img src="http://verify.fourthforce.in/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
var oneemp=employimg_obj.document;
// /alert(oneemp);
  $('.sdd').append('<li><a href="http://verify.fourthforce.in/uploads/'+oneemp+'"><img src="http://verify.fourthforce.in/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(oneemp);
  $('.sdd').append('<li><a href="http://verify.fourthforce.in/documents/addressid/'+oneemp+'"><img src="http://verify.fourthforce.in/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
